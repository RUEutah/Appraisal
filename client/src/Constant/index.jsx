...
export const AppQuestions = 'Appraisal Questions';
...
// Default Dashboard //
export const Welcome = 'Welcome to City Parking';
export const WelcomeMessage = 'Here! Take a look at whats happening in your account today';
...
// Online Course //
export const HelloJashmin = ' Hello Rue';
...
export const TodayProgressTitle = 'Appraisal Progress';
export const TodayProgressMessage = 'Your Goal Almost Done!';
...
export const AllCampaignsTitle = 'Appraisal Sessions';
...
export const Profile = 'Appraisees';
...
export const NewAppraisal = 'New Appraisal';
export const NewUsers = 'New User';
...
export const BasicProgressBars = 'Questions Progress';
...
export const AddUser = 'Create User';
export const AddAppraisal = 'Add Appraisal';
...
export const AppraisalDetails = 'Appraisal Details';
...
export const AreaSpalineChart = 'sentiment Chart';
...
export const PieChart = 'Forms Chart';
...
export const RadialBarChart = 'Feedback Bar Chart';
...
export const Questions = 'What do you consider to be your most important achievement so far?';
...
export const AppraisalQuestions = 'Appraisal Questions';
export const AppraisalAnswers = 'Appraisal Answers';
export const Answers = 'Answer: Creating a system';
...
export const TotalPerformanceAp = 'Total Performace Appraisals';
export const CompareToLast = 'Compare to last session';
...
export const TotalSalaryAp = 'Total Salary Appraisals';
