...
import { WelcomeMessage, Welcome} from '../../../Constant';
import CarToon from '../../../assets/images/dashboard/cartoon.svg';
import App from './NewModal';

const GreetingCard = () => {
  return (
    <Col  className='col-xxl-12 col-sm-12 box-col-12'>
      <Card className=' profile-box' style={{ marginRight: '0', width: '100%', height: '330px'}}> 
        <CardBody>
          <Media>
            <Media body>
              <div className='greeting-user'>
                <H4 attrH4={{ className: 'f-w-600', style: { fontSize: '2.5rem', fontWeight: 'bold' } }}>
                  {Welcome}
                </H4>
                <P attrP={{style: { fontSize: '1.5rem', fontWeight: 'bold' }}}>{WelcomeMessage}</P>
                <div>
                  <App/>
                </div>
              </div>
